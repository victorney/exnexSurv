...
truncated-Normal conditional distribution, which makes every full
conditional conjugate and the systematic Gibbs scan exact. The sampler
is implemented in C++/RcppArmadillo and is roughly 25× faster than a
marginalized Stan implementation of the same model on the paper’s
simulation study.
